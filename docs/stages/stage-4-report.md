...
- 状态：`passed`。实现提交、正式联合演练证据、证据 Schema 和统一门禁均已通过。
...
- 正式验收：2026-08-17 11:01 CST 在干净修订 `ea46c8a7192054cefd91f2c9c3d62330a99cfcad` 原样执行 `./platform accept-stage-4-tools`；前后两轮 13 项 doctor 均通过，数据库 Revision 为 `20260816_0061`，固定 8 个场景实际执行 `9/9` case，六类样本汇总为成功 `1`、失败 `5`、超时 `2`、取消 `1`、恢复 `3`、拒绝 `3`，零失败、错误、跳过或未运行。正式证据 `.ai-platform/evidence/p4-12-latest.json` 的清单 SHA-256 为 `c7886e87…64d7604`，证据文件 SHA-256 为 `e8e094aa…806319`，独立通过 Draft 2020-12 Schema 校验；P4-12 验收器再次 `37/37` 通过。
