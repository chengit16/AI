...
P6A-06 已完成阶段 A 联合验收。阶段 B 的 P6B-01 已完成企业控制台聚合、授权裁剪、Registry 29 和 Revision `20260831_0076`；P6B-02 已完成团队统一聚合、邀请撤销、成员组织与角色原子配置、停用/恢复/移除、Registry 30 和 Revision `20260831_0077`；P6B-03 已完成企业分类、团队知识域、范围交集解释、Registry 31 和 Revision `20260831_0078`；P6B-04 已完成企业文档发布审批门户、最终批准重新鉴权、文档与索引指针原子切换、Registry 32、生命周期 Registry 21 和 Revision `20260831_0079`，完整门禁、容器诊断和双视口正式合成数据验收均已通过，功能提交为 `bddeb28`。P6B-05 已完成角色权限矩阵、影响成员、审计详情和异步导出实现与验证，Registry 35、字段策略 Registry 3、生命周期 Registry 22 和 Revision `20260903_0080` 已生效，完整门禁、13 项诊断、真实 Worker 和双视口合成数据验收均通过，功能提交为 `111b585`。P6B-06 已完成 `conversation_kind='enterprise_brain'`、知识域/RAG 策略冻结、每次提问重新鉴权、SSE/来源/反馈/归档、不可变 Markdown 报告、双视口正式合成数据验证和最终统一门禁；Registry 38 与 Revision `20260903_0081` 已在运行环境生效，功能提交为 `715a319`，当前执行 P6B-07。阶段 A 联合验收使用冻结的 `p6a06-v1` 合成清单，12/12 场景通过，前置与恢复 `./platform doctor` 正常；桌面 `1440×900` 与移动 `390×844` 的浏览器证据复用 P6A-02～P6A-05 已完成的真实合成数据验收，未将联合验收器描述为自动浏览器测试。
