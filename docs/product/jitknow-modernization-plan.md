...
> 当前进度：`P6A-01`～`P6A-04` 已完成，`P6A-05` 已实现并完成本地验收；继续执行 `P6A-06` 及阶段 B
...
截至 2026-08-31，阶段 A 已完成范围冻结、文件夹/标签/收藏/回收站、文件型文档详情与授权下载、个人工作台与全局搜索，以及 AI 助手体验五个节点。`P6A-05` 使用 Revision `20260830_0075`，完成知识库/标签范围、临时 UTF-8 文本附件、快捷指令、Run 范围冻结和会话归档；专项测试、统一门禁、13 项运行诊断和桌面/移动双视口真实数据验收通过。临时附件最多 3 个、单个最多 20,000 字节，仅进入当前 Run 上下文，不写入知识库、索引或文档正文；归档时清理附件正文。真实供应商质量、成本和数据政策仍受阶段 5 门禁约束，在线正文、文档 AI 写回和多人实时协作仍不进入第一版。
